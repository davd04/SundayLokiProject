...
public class EbayHomePageActions {
	...
	public void linkMyEbay() throws Exception{
	...
	public void linkSummary() throws Exception{
	...
	public void synchronization(){
		...
		wait.until(ExpectedConditions.elementToBeClickable(EbayHomePageLocatorsObj.btnSearch));
